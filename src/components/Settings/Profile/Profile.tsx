...
const EditProfile: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        const result: ProfileUpdateResponse | ProfileUpdateErrorResponse =
          await editProfileService.getProfile(userId);
        setLoading(false);
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      const result: ProfileUpdateResponse | ProfileUpdateErrorResponse =
        await editProfileService.editProfile(userId, profileUpdateData);
      setLoading(false);
