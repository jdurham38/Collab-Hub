...
const SignupForm: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (!isUsernameValid) {
      setErrorMessage(
        'Sorry, this username is already taken or invalid. Please try another.',
      );
      formIsValid = false;
    }
    ...
    try {
      ...
      const userData: UserData = {
        ...
        role: selectedRole,
        profileImageUrl:
          'https://mmcljxvypquukmlbybbv.supabase.co/storage/v1/object/public/profile-images/preset-images/default1.png',
      };
    ...
    <>
      <form onSubmit={handleSignup} className={styles.form} noValidate>
        <div className={styles.inputGroup}>
          ...
          />
          {isUsernameChecking && (
            <p className={styles.info}>Checking username availability...</p>
          )}
        ...
        <div className={styles.inputGroup}>
          ...
          >
            <option value="" disabled>
              Select a Role Best Describing You
            </option>
          ...
          {roleError && (
            <p id="role-error" className={styles.error}>
        ...
        <button
          type="submit"
          disabled={loading || isUsernameChecking}
