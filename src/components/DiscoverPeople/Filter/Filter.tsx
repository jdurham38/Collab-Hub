...
interface UserFilterProps {
    onFilterChange: (filters: { roles: string[]; dateRange: string; searchTerm: string }) => void;
    initialFilters?: { roles: string[]; dateRange: string; searchTerm: string };
}

const UserFilter: React.FC<UserFilterProps> = ({ onFilterChange, initialFilters }) => {
    ...
    const handleDateRangeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        setLocalFilters((prevFilters) => ({ ...prevFilters, dateRange: e.target.value }));
    };

    const handleSearchTermChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setLocalFilters((prevFilters) => ({ ...prevFilters, searchTerm: e.target.value }));
    };
