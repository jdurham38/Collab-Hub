...
const UserProfilePage: React.FC = () => {
  ...
  const [userInfo, setUserInfo] = useState<
    (User & { projectCount?: number; friendCount?: number }) | null
  >(null);
  ...
  return (
    <div className={styles.userProfileContainer}>
      <div className={styles.profileHeader}>
        ...
        <div>
          <h2 className={styles.usernameRole}>
            {userInfo.username} - {userInfo.role}
          </h2>
          {userInfo?.shortBio && (
            <p className={styles.shortBio}>{userInfo.shortBio}</p>
          )}
      ...
      <div className={styles.buttonContainer}>
        ...
        <button className={styles.userButton} onClick={openOverlay}>
          Invite to Project
        </button>
        <button className={styles.userButton}>Message</button>
        {isOverlayOpen && (
          <ProjectInviteOverlay receiverId={id} onClose={closeOverlay} />
        )}
      </div>
    </div>
  );
