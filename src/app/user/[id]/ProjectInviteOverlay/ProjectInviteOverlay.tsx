...
const ProjectInviteOverlay: React.FC<ProjectInviteOverlayProps> = ({ receiverId, onClose }) => {
        ...
        const fetchProjects = async () => {
            ...
            try {
                ...
                if (e instanceof Error) {
                    errorMessage = e.message || 'An error occurred while fetching projects.';
        ...
        try {
            ...
            let errorMessage = "An unexpected error occurred.";
             if (error instanceof Error) {
                 errorMessage = error.message || 'An error occurred while sending the invite.';
