...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const { setUnreadCount, incrementUnreadCount, resetUnreadCount } =
    useUnreadStore();
  ...
  const allCollaborators = projectOwner
    ? [
        ...collaborators,
        {
          ...projectOwner,
        ...
        <ul className={styles.channelList}>
          {channelList.map((channel) => (
            <ChannelListItem
              ...
              onClick={() =>
                handleSetActiveChat({ ...channel, type: 'channel' })
              }
            />
          ))}
        </ul>
          ...
          {allCollaborators.map((collaborator) => (
            <li
              ...
              className={`${styles.button} ${
                activeChat?.recipient_id === collaborator.userId &&
                activeChat?.type === 'dm'
                  ? styles.active
                  : ''
              }`}
